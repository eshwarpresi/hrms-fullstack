...
const REACT_APP_API_URL = 'https://hrms-fullstack-1-lar5.onrender.com/api';
...
export const teamAPI = {
  ...
  update: (id, data) => api.put(`/teams/${id}`, data), // ADDED THIS
  delete: (id) => api.delete(`/teams/${id}`), // ADDED THIS
